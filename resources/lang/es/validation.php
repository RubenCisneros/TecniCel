...
return [
    ...
    'custom'               => [
        ...
        'password' => [
            ...
            'max' => 'La contraseña no debe ser mayor a :max caracteres.',
        ...
        'first_surname' => [
            ...
            'max' => 'El apellido paterno no debe ser mayor a :max caracteres'
        ],
        'second_surname' => [
            'required' => 'El apellido materno es obligatorio.',
            'max' => 'El apellido materno no debe ser mayor a :max caracteres'
        ],
        'brand' => [
            'required' => 'El nombre de la marca es obligatorio.',
            'unique' => 'Ya hay una categoría con este nombre y marca.'
        ]
    ],
];
